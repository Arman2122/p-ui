...
description: The ports Penhoon UI uses by default and ready-made ufw / nftables rules to open them.
icon: Network
---
...
<Cards>
  ...
  <Card title="Environment variables" href="/docs/reference/env-vars" description="PUI_PORT and friends." />
</Cards>
