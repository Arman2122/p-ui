---
title: API Reference
description: The Penhoon UI REST API — authentication, inbounds, clients, server stats, and more, generated from the OpenAPI spec.
icon: Webhook
---

Penhoon UI exposes a REST API for automation. These pages are generated from the
panel's OpenAPI specification, so they always match the documented schema.
