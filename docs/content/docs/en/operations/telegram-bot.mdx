---
title: Telegram Bot
description: Connect a Telegram bot to p-ui for commands, periodic reports, event alerts (login, CPU, node up/down), backups, and client self-service.
icon: Send
---

p-ui can drive a Telegram bot for monitoring, alerts, backups, and remote
