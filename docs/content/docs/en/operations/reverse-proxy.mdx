---
title: Reverse Proxy
description: Put the Penhoon UI panel and subscription behind Nginx or Caddy with Let's Encrypt TLS.
icon: Waypoints
---
...
[`p-ui` SSL menu](/docs/config/ssl-certificates) instead.
...
- If you terminate TLS at the proxy, you may want `PUI_SKIP_HSTS=true` on the
