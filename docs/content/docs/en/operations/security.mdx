---
title: Security
description: Harden p-ui — panel auth and 2FA, Fail2ban IP limits, firewall rules, BBR, and staying current.
icon: ShieldCheck
---
...
p-ui installs and configures for you (enabled by default on script installs, and
...
- The jail is named **`3x-ipl`**; ban logs live at `/var/log/p-ui/3xipl.log` and
  `/var/log/p-ui/3xipl-banned.log` (also via `p-ui banlog`).
...
Update p-ui and Xray-core regularly — security fixes land in new releases. Watch
