---
title: p-ui Documentation
description: Official documentation for p-ui — an advanced web panel for managing Xray-core servers, proxies, clients, and subscriptions.
icon: House
---

**p-ui** is an open-source web panel for deploying and managing
...
<Callout type="info">
  New to Xray? Read [What is p-ui?](/docs/guide) first — it explains how the panel, Xray-core, and
