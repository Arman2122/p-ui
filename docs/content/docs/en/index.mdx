---
title: Penhoon UI Documentation
description: Official documentation for Penhoon UI — an advanced web panel for managing Xray-core servers, proxies, clients, and subscriptions.
icon: House
---

**Penhoon UI** is an open-source web panel for deploying and managing
...
<Cards>
  ...
  <Card
    ...
    description="Install on Ubuntu or Debian via script, or manually."
  />
  <Card
    title="First login"
...
<Callout type="info">
  New to Xray? Read [What is Penhoon UI?](/docs/guide) first — it explains how the panel, Xray-core, and
