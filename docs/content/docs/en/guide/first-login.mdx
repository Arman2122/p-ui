---
title: First Login
description: Find your generated p-ui credentials, reach the panel, enable two-factor auth, and harden it before exposing anything.
icon: KeyRound
---
...
p-ui supports TOTP two-factor auth (compatible with Google Authenticator, Aegis,
