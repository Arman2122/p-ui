---
title: Installation
description: Install Penhoon UI via the official script (stable, pinned, or dev-latest), unattended/cloud-init, or Docker — and choose SQLite or PostgreSQL.
icon: Download
---

Penhoon UI runs on a wide range of Linux distributions — Ubuntu, Debian, Armbian,
