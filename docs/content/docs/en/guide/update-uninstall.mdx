...
description: Manage p-ui with the p-ui menu and CLI — update (stable, dev, or legacy), change settings, and uninstall cleanly.
icon: RefreshCw
---
...
| 6     | Uninstall                              | Remove p-ui (see below)                                  |
...
| `p-ui migrate-db --dsn …`  | Migrate SQLite → PostgreSQL (see [Database](/docs/reference/database)) |
