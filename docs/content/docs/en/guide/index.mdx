...
**p-ui** is a web control panel that sits on top of
...
<Mermaid
  chart={`
flowchart LR
  Admin["Admin browser"] -->|HTTPS panel| Panel["p-ui panel"]
...
p-ui is aimed at anyone running their own Xray server: from a single personal
...
<Callout type="info">
  p-ui is an enhanced fork of the original P-UI project, adding broader protocol
