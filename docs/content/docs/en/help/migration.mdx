---
title: Migration
description: Migrate to p-ui from p-ui, between servers, or between p-ui versions.
icon: ArrowRightLeft
---
...
<Step>
### Install p-ui on the new server
...
Importing an older p-ui panel's database directly into p-ui is **not
supported** — the schemas differ. Install p-ui fresh and recreate
