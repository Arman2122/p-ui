---
title: Contributing
description: How to contribute to p-ui and to translate this documentation.
icon: GitPullRequestArrow
---

p-ui is community-driven. Contributions to the panel and to these docs are
welcome.

## Support the developer

p-ui is free and open source, built and maintained in the open. If it's useful
