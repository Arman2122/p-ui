---
title: مرجع API
description: REST API پنل p-ui — احراز هویت، inboundها، کلاینت‌ها، آمار سرور و موارد دیگر، تولیدشده از مشخصات OpenAPI.
icon: Webhook
---

پنل p-ui یک REST API برای خودکارسازی در اختیار می‌گذارد. این صفحات از مشخصات
