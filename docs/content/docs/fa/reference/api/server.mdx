...
_openapi:
  ...
  toc:
    ...
    - depth: 2
      title: >-
        Stream a full database backup as an attachment — a pg_dump custom-format
        archive (.dump). Use as a manual backup.
      url: >-
        #stream-a-full-database-backup-as-an-attachment--a-pg_dump-custom-format-archive-dump-use-as-a-manual-backup
    - depth: 2
    ...
    - depth: 2
      title: >-
        Restore the panel DB from an uploaded pg_dump archive (.dump), sent as
        multipart form field "db" and loaded with pg_restore. The panel restarts
        after restore. Destructive.
      url: >-
        #restore-the-panel-db-from-an-uploaded-pg_dump-archive-dump-sent-as-multipart-form-field-db-and-loaded-with-pg_restore-the-panel-restarts-after-restore-destructive
    - depth: 2
      title: >-
  ...
  structuredData:
    headings:
      ...
      - content: >-
          Stream a full database backup as an attachment — a pg_dump
