---
title: مستندات Penhoon UI
description: مستندات رسمی Penhoon UI — یک پنل وب پیشرفته برای مدیریت سرورهای Xray-core، پروکسی‌ها، کلاینت‌ها و سابسکریپشن‌ها.
icon: House
---

**Penhoon UI** یک پنل وب متن‌باز برای استقرار و مدیریت سرورهای
...
<Cards>
  ...
  <Card
    ...
    description="نصب روی Ubuntu یا Debian با اسکریپت، یا به‌صورت دستی."
  />
  <Card
    title="نخستین ورود"
...
<Callout type="info">
  با Xray تازه آشنا شده‌اید؟ ابتدا [Penhoon UI چیست؟](/docs/guide) را بخوانید — توضیح می‌دهد که پنل، Xray-core و
