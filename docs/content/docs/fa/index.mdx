---
title: مستندات p-ui
description: مستندات رسمی p-ui — یک پنل وب پیشرفته برای مدیریت سرورهای Xray-core، پروکسی‌ها، کلاینت‌ها و سابسکریپشن‌ها.
icon: House
---

**p-ui** یک پنل وب متن‌باز برای استقرار و مدیریت سرورهای
...
<Callout type="info">
  با Xray تازه آشنا شده‌اید؟ ابتدا [p-ui چیست؟](/docs/guide) را بخوانید — توضیح می‌دهد که پنل، Xray-core و
