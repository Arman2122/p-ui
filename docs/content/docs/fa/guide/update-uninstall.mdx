...
description: مدیریت p-ui با منوی p-ui و خط فرمان — به‌روزرسانی (پایدار، dev یا نسخه‌های قدیمی)، تغییر تنظیمات و حذف تمیز و کامل.
icon: RefreshCw
---
...
| 6     | Uninstall                              | حذف p-ui (در ادامه ببینید)                                |
...
| `p-ui migrate-db --dsn …`  | مهاجرت SQLite ← PostgreSQL (نگاه کنید به [پایگاه‌داده](/docs/reference/database)) |
