---
title: پراکسی معکوس
description: قرار دادن پنل و اشتراک Penhoon UI پشت Nginx یا Caddy همراه با TLS از Let's Encrypt.
icon: Waypoints
---
...
[منوی SSL در `p-ui`](/docs/config/ssl-certificates) دریافت کنید.
...
- اگر TLS را در پراکسی مدیریت می‌کنید، ممکن است بخواهید `PUI_SKIP_HSTS=true` را روی
