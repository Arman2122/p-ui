...
// The p-ui product repository — used for the navbar GitHub link,
...
// Where these docs live in the p-ui monorepo — used for "Edit on GitHub" links.
...
// AI-generated interactive wiki of the p-ui codebase.
export const deepWikiUrl = `https://deepwiki.com/${productRepo.user}/${productRepo.repo}`;

// Official p-ui community channel on Telegram (announcements & support).
