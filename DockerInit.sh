...
MTG_MULTI_VER=$(curl -sfL "https://api.github.com/repos/arman2122/mtg-multi/releases/latest" | sed -n 's/.*"tag_name": *"\([^"]*\)".*/\1/p' | head -n 1)
...
curl -sfLRO "https://github.com/arman2122/mtg-multi/releases/download/${MTG_MULTI_VER}/${MTG_PKG}.tar.gz"
