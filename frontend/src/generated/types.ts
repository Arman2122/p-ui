...
export type ProcessState = 'running' | 'stop' | 'error';
export type Protocol = 'vmess' | 'vless' | 'tunnel' | 'http' | 'trojan' | 'shadowsocks' | 'mixed' | 'wireguard' | 'hysteria' | 'mtproto' | 'wgkernel' | 'awgkernel' | 'tun';
