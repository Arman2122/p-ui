...
func TestEnsureURLScheme(t *testing.T) {
	tests := []struct {
		...
		{"empty", "", ""},
		{"whitespace only", "   ", ""},
		{"bare telegram handle", "t.me/pui_support", "https://t.me/pui_support"},
		{"bare domain with path", "example.com/help", "https://example.com/help"},
		{"already https", "https://t.me/pui_support", "https://t.me/pui_support"},
		{"already http", "http://example.com", "http://example.com"},
		{"telegram deep link", "tg://resolve?domain=pui_support", "tg://resolve?domain=pui_support"},
		{"mailto", "mailto:support@example.com", "mailto:support@example.com"},
		{"tel", "tel:+1234567890", "tel:+1234567890"},
		{"trims whitespace", "  t.me/pui_support  ", "https://t.me/pui_support"},
	}
