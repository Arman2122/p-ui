...
var dispatchBudget = map[string]int{
	...
	"internal/web/service/client_inbound_apply.go": 12,
	"internal/web/service/xray.go":                 10,
	"internal/web/runtime/local.go":                9,
	...
	"internal/web/service/client_bulk.go":          1,
